...
export function ChatPanel({ trialId, onClose }: ChatPanelProps) {
    const {
        messages,
        isStreaming,
        error,
                ...
                <div className="flex-1 overflow-auto p-4 space-y-4">
                    ...
                    {sessionId && messages.length === 0 && !error && (
                        <div className="space-y-4">
                            <p className="text-sm text-muted-foreground">
                                Ask questions about your trial data. Claude can analyze
                                fitness trends, compare snapshots, trace lineage, and more.
                            </p>
