...
export default function RepoBrowser({ trialId }: RepoBrowserProps) {
    const { tree, isLoading: treeLoading, error: treeError, refresh } = useRepoFileTree(trialId);
    const { content, isLoading: contentLoading, error: contentError, loadFile, clearContent } = useRepoFileContent(trialId);
